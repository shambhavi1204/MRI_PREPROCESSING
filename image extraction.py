                ...
                if data_types[0] in each_file:
                    for i in range(data.shape[0]):
                        ...
                        if temp!=0:
                            ...
                            name = str("D:\\adc\\training\\OT\\"+prefix[c]+"_"+imgNum[flairImg]+".jpg")
...
np.save("D:\\Names_names",img_name)
#other data extract
                ...
                if ".nii" in each_file:
                    ...
                    if key in each_file:
                        for i in range(blank_slide_list[p-1][0],data.shape[0]-blank_slide_list[p-1][1]):
                            ...
                            name = str("D:\\adc\\training\\"+str(key)+"\\"+prefix[c]+"_"+imgNum[count]+".jpg")
                            img = data[i]
                            img = img[19:211,19:211]
                            plt.imsave(name,img,cmap='gray')                      
                            count+=1
